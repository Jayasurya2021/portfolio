...
export default function AboutSection() {
    ...
    return (
        <section ref={containerRef} id="about" className="relative w-full bg-white dark:bg-[#0a0a0a] text-black dark:text-white py-20 md:py-40 lg:py-64 overflow-hidden">
            ...
            <div className="w-full mx-auto px-4 sm:px-6 md:px-12 lg:px-24 xl:px-32 max-w-[1920px] relative z-10 grid grid-cols-1 gap-16 sm:gap-32 md:gap-48 lg:gap-[300px]">
