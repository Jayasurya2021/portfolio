        ...
        >
            ...
            >
                ...
                <div className="flex justify-between items-start mb-6 md:mb-8 w-full shrink-0">
                    <div className="flex items-center gap-4 md:gap-8">
                        ...
                        <motion.h2
                            ...
                            className="text-5xl md:text-6xl font-black text-gray-900 dark:text-[#f1f5f9] tracking-tighter leading-none"
                        >
                            0{index + 1}
                        </motion.h2>
                        {/* Subtitle & Title */}
                        <div className="flex flex-col justify-center gap-1 mt-1">
                            <h3 className="text-xl sm:text-2xl md:text-3xl font-black text-gray-900 dark:text-[#f1f5f9] uppercase tracking-wider">
                                {project.title}
                            </h3>
                ...
                <div className="relative flex-1 w-full bg-gray-50 dark:bg-[#111] rounded-[20px] border border-gray-100 dark:border-white/10 overflow-hidden flex flex-col md:flex-row shadow-inner group/inner">
                    ...
                    {/* Left Content */}
                    <div className="w-full p-6 md:p-8 flex flex-col justify-center relative z-10 bg-gradient-to-r from-gray-50 via-gray-50 to-transparent md:bg-none backdrop-blur-sm md:backdrop-blur-none bg-gray-50 dark:bg-[#111] overflow-y-auto" style={{ flex: '1 1 50%' }}>
                        <motion.div
                    ...
                    {/* Right Content / Image */}
                    <div className="w-full relative overflow-hidden bg-gray-200 dark:bg-[#222] shrink-0" style={{ flex: '1 1 50%' }}>
                        <motion.img
                            initial={{ scale: 1.15 }}
                            whileInView={{ scale: 1 }}
                            viewport={{ once: true }}
...
export default function ProjectsSection() {
    return (
        <section
            id="projects"
            className="relative w-full bg-white dark:bg-[#0a0a0a] pt-16 pb-0 scroll-mt-24"
        >
