...
const projects = [
    ...
    },
    {
        id: 2,
        title: 'CRM',
        subtitle: 'Everything Your Business Needs, Unified.',
        description:
            'A modern CRM application for managing customers, sales, projects, inventory, and support with an intuitive and responsive interface.',
        features: [
    ...
    },
    {
        ...
        image: '/assets/mockeefy.png',
        tech: ['Real-Time Collaboration', 'Scalable Architecture'],
        demo: 'https://www.mockeefy.com/',
        repo: '#',
    ...
    },
    {
        ...
        image: '/assets/vecalassist.png',
        tech: ['AI Integration', 'IoT Ecosystem', 'Steel Frame'],
        demo: 'https://vehicleassist-bay.vercel.app/',
        repo: '#',
